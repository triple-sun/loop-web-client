...
import type { Channel } from '../../oldsrc/client/types/channels';
import type { Post } from '../../oldsrc/client/types/posts';
...
export type UserThread = {
  ...
  participants: Array<{ id: UserProfileResponse['id'] } | UserProfileResponse>;
